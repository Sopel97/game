...
std::vector<ALLEGRO_VERTEX> AllegroUtil::constructQuadAsTriangleList(const Vec2F& topLeft, const Vec2F& bottomRight, const Vec2F& uv, ALLEGRO_COLOR color)
{
...
void AllegroUtil::appendQuadAsTriangleList(std::vector<ALLEGRO_VERTEX>& vec, const Vec2F& topLeft, const Vec2F& bottomRight, const Vec2F& uv, ALLEGRO_COLOR color)
{
...
std::vector<ALLEGRO_VERTEX> AllegroUtil::constructQuadAsTriangleFan(const Vec2F& topLeft, const Vec2F& bottomRight, const Vec2F& uv, ALLEGRO_COLOR color)
{
...
void AllegroUtil::appendQuadAsTriangleFan(std::vector<ALLEGRO_VERTEX>& vec, const Vec2F& topLeft, const Vec2F& bottomRight, const Vec2F& uv, ALLEGRO_COLOR color)
{
